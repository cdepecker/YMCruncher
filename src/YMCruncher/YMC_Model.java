...
{		
	...
	public YMC_Model()
		{
			...
			{
				System.out.println("Error : No available Input Plugins detected");
				System.exit(-1);
			}
			...
			{
				System.out.println("Error : No available Output Plugins detected");
				System.exit(-1);
			}
			try {
	 ...
	 * @return arrOutputPlugins Vector of available Output Plugins
	 */
