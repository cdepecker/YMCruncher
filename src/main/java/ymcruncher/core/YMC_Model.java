...
public class YMC_Model extends Observable {
    final static String strApplicationName = "YaMaha Cruncher - " + YMCProperties.properties.getProperty("version");
    ...
    private List<InputPlugin> arrInputPlugins = InputPlugin.getInputPlugins();

    // OutputPlugins definition
    private List<OutputPlugin> arrOutputPlugins = new ArrayList<OutputPlugin>();
    ...
    public YMC_Model() {
        ...
        arrOutputPlugins = OutputPlugin.getOutputPlugins();
     ...
     */
    List<OutputPlugin> getOutuptPlugins() {
    ...
    private ArrayList<Byte> getArrayListFromInputStream(InputStream in) {
        ArrayList<Byte> arrData = new ArrayList<Byte>();
        try {
    ...
    public Chiptune getData(String strSourceFile) {
         ...
         */
        for (InputPlugin inp: arrInputPlugins) {
